...
class Constants(BaseConstants):
    ...
    quiz_hints = [
        'To meet the 60% energy conservation goal, each player should contribute 6 \
            energy tokens each month to the group conservation account, resulting \
            in 900 energy tokens at the end of the game.',
        'Each token in the group conservation account equals $0.01 dollars. The \
            dollar value of the group conservation account is contributed to Carbonfund.org.',
        'You will have greater earnings if you put all of your energy tokens \
            ...
            while others will only earn the $1.15 bonus. (If wrong take back to \
                3rd page of EXAMPLES: full table',
        'The group gets the maximum financial payment if all players contribute \
            ...
            share of the maximum bonus possible, which is \
    ...
    survey_1_q1 = 'What were you trying to do in the experiment (in \
        other words: what were your goals or objectives)?'
    survey_1_q2 = 'Did you achieve your objectives?'
    survey_1_q3 = 'What information guided your contributions throughout the game?'
    survey_1_q4 = 'What were the other members of your group trying to \
        do (what were their objectives)?'
    survey_1_q5 = 'What was the scope of this experiment (in other \
        words, what were the experimenters trying to discover)?'
    ...
    survey_1_qb3 = 'One must try to work together with others to \
        have everyone end up with more money.'
    survey_1_qb4 = 'The group goal did not matter because any conservation \
        had an impact (it was donated to remove air pollution in the US).'
    ...
    survey_1_qc3 = 'Total contributions to date (yours and others\' \
        together) to the group conservation account'
    survey_1_qc4 = 'Percentage of group goal met'
    survey_1_qc5 = 'The environmental benefits of conservation (the \
        donation to remove air pollution in the US)'
    ...
    survey_4_items = [
        ...
        'Are your responses reliable enough for us to include them in our academic \
            research that will have real implications on energy and housing \
