...
# RUNNING IN PRODUCITON. IF THIS IS NOT DONE FIRST SETTING 'OTREE_PRODUCTION' 
# WILL CAUSE A FATAL ERROR ON THE HEROKU SERVERS SINCE THEY ARE 'READ-ONLY' 
# THE OTREE APP CANNOT WRITE FILES TO DISK THAT ARE NOT ENTERED THROUH GIT 
...
# VERSION. **IF YOU ARE READY TO RESET THE DATABASE RUN THE FOLLOWING COMMAND**
...
# TO THE PREVIOUS VERISON VERY QUICKLY. ONCE YOU'VE DONE THIS, REMEMBER TO 
...
# ## WORKING PATHS 
# ====================
# THE MAIN APP IS INSTALLED IN A SUBDIRECTORY OF THE MAIN FOLDER TO KEEP BUILD FILES
# NOTES AND DEVELOPMENT SCRIPTS OUT OF THE PATHS WHERE THEY MIGHT ACCIDENTALLY BE 
# SERVED OR EXECUTED REMOTELY, ALSO THIS PROVIDES A CLEANER PROJECT STRUCTURE.
# THIS DOES CAUSE SOME OF THE MANAGEMENT COMMANDS TO EXECUTE IN THE WRONG DIRECTORY
# 
# IF A HEROKU COMMAND FAILS TO RUN OR RETURNS NO RESULT, TRY CHANGING DIR TO THE APP
# FOLDER AND CHAINING THE COMMANDS. NOTE: PAY ATTETION TO QUOTATIONS, THE EXECUTABLE
# STATEMENT MUST BE SENT TO THE HEROKU SERVICE AS A SINGLE STRING, IF YOU UNESCAPE PARTS
# THEN IT WILL NOT RUN AS EXPECTED
