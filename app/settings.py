...
SESSION_CONFIGS = [
    ...
    },
    {
        ...
        'display_name': "Descriptive Norm Text Game",
        'num_demo_participants': 1,
        'app_sequence': ['quiz', 'game', 'survey', 'results'],
    ...
    },
    {
        ...
        'display_name': "Injunctive Norm Text Game",
        'num_demo_participants': 1,
        'app_sequence': ['quiz', 'game', 'survey', 'results'],
    ...
    },
    {
        ...
        'display_name': "MTurk Descriptive Norm Text Game (mturk)",
        'num_demo_participants': 1,
        'app_sequence': ['quiz', 'game', 'survey'],
        'game_type': 'descriptive_text',
        'mturk_hit_settings': MTURK_HIT_SETTINGS,
    },
    {
        ...
        'display_name': "MTurk Injunctive Norm Text Game (mturk)",
        'num_demo_participants': 1,
        'app_sequence': ['quiz', 'game', 'survey'],
        'game_type': 'injunctive_text',
        'mturk_hit_settings': MTURK_HIT_SETTINGS,
