...
SESSION_CONFIGS = [
    {
        'name': 'descriptive',
        'display_name': "Descriptive (4 rounds)",
        'num_demo_participants': 22,
        'app_sequence': ['descriptive']
    },
    {
        'name': 'visualpfull',
        'display_name': "Full Animated Proximity Chart (4 rounds)",
        'num_demo_participants': 22,
        'app_sequence': ['visualpfull'],
    },
    {
        'name': 'visualpfullnoanim',
        'display_name': "Full Non-Animated Proximity Chart (4 rounds)",
        'num_demo_participants': 22,
        'app_sequence': ['visualpfullnoanim'],
    },
    {
        'name': 'visualrfull',
        'display_name': "Full Animated Radial Chart (4 rounds)",
        'num_demo_participants': 22,
        'app_sequence': ['visualrfull'],
    },
    {
        'name': 'visualrfullnoanim',
        'display_name': "Full Non-Animated Radial Chart (4 rounds)",
        'num_demo_participants': 22,
